...
using Cinema.Infrastructure.Redis;
...
namespace Cinema.Infrastructure.DI
{
    public static class ServiceContainer
    {
        public static IServiceCollection AddInfrastructureServie(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.AddSingleton<IConnectionMultiplexer>(ConnectionMultiplexer.Connect(config.GetConnectionString("redisConnection")));
